...
export interface ClassTransformOptions {
   ...
   *
   * This option requires that each property on the target class has at least one `@expose` or `@conceal` decorator
  ...
  /**
   * If set to true then class transformer will ignore the effect of all @expose and @conceal decorators.
  ...
  /**
   * Target maps allows to set a Types of the transforming object without using @nest decorator.
